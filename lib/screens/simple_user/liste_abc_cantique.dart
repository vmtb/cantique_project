...
class _ListeAbcCantiqueState extends ConsumerState<ListeAbcCantique> {
          ...
          return Container(
            ...
            child: ListView.separated(
              itemBuilder: ((context, index) {
                Map<String, List<CantiqueModel>> newData = datas[index];
                List<CantiqueModel> values = newData.values.first;
  ...
  List<Map<String, List<CantiqueModel>>> datas = [];
  bool isLoading = true;
  Future<void> loadCantiqueABC() async {
    datas = await ref.read(CantiqueCrudController).getAbcCantique();
    setState(() {
      isLoading = false;
    });
  }
